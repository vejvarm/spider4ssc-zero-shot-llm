...
import evaluate
from spider4ssc_zeroshot.vendor.ut5_ssc.seq2seq.metrics.spidersparql.spider_test_suite import compute_test_suite_metric
from spider4ssc_zeroshot.vendor.ut5_ssc.seq2seq.metrics.spidersparql.spider_exact_match import compute_exact_match_metric
import datasets
...
class SpiderSSC(evaluate.Metric):
    def __init__(
        self,
        ...
        **kwargs
        ...
        self.lang: Optional[str] = kwargs.get("metric_lang", "sparql")
        if self.lang not in ["sparql"]: raise NotImplementedError("Metric langugage must be `sparql`")
