...
Spider4SSC can be copied from a local source tree with `spider4ssc-zeroshot prepare-data --source ...`. For remote archive downloads, `dataset.archive_sha256` is optional but recommended for release reproduction; when provided, it is verified before extraction.
